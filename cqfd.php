		...
		<div id="bloc_page">
			...
			<section class="home">
				...
				<section class="contenu">
					...
					<iframe width="1140" height="563" src="https://www.youtube.com/embed/CS_rxeIgwR4?showinfo=0" frameborder="0" allowfullscreen></iframe>
					...
					<img width="1140" height="563" src="image/cqfd/cqfd2.jpg" alt="Image du jeu" />
					...
					<p>
						...
						<br />Ma <span>seconde</span> mission : <span>Refondre l'épreuve de Thalès</span>. A mon arrivé dans le projet, l'épreuve de Thalès exister déjà, mais manquait cruellement de <span>ré-jouabilité</span> et d'<span>ergonomie</span>.
						<br />Un des gros points négatif du jeu, était le manque <span>d'informations</span> et de <span>guidage</span>. Le joueur était lâché dans la nature sans savoir quoi faire. Pour palier à cette démotivation des joueurs, l'objectif  était <span>d'introduire</span> des <span>instructions</span>.
						<br />Afin <span>d'homogénéiser</span> le jeu avec la <span>plateforme</span> d'hébergement et les contraintes techniques, j'ai donc été chargé de <span>refondre</span> l'<span>Interface Utilisateur</span>. Pour cela j'ai utiliser le style <span>Flat Design</span>, sobre et épuré, qui en plus nous as permis <span>d'alléger</span> la taille du build, un <span>facteur critique</span> pour un jeu en ligne.
					</p>
					<img width="1140" height="563" src="image/cqfd/cqfd3.jpg" alt="Image du jeu" />
					...
					<p>
						...
						<br />Pour le module de Découverte, j'ai fais le choix d'apporter de la scénarisation : Thalès étudie les ombres projetées d’objets et leurs tailles. L’élève lui vient alors en aide pour découvrir ensemble ce qui s’appellera par la suite, le théorème de Thalès.
					</p>
					<iframe width="1140" height="563" src="https://www.youtube.com/embed/EVvMaBeTl54?loop=1&playlist=EVvMaBeTl54&showinfo=0&autoplay=1&controls=0" frameborder="0" allowfullscreen></iframe>
					<p>
						...
						<br />Pour mieux se rendre compte de l'influence de la source lumineuse sur ce rapport d'agrandissement, l'élève manipule la lumière. La forme de l'ombre projetée au sol de la figure est alors <span>recalculé en temps réel</span>.
						<br />Pour les <span>Exercices</span>, la plus grande difficulté était d'obtenir des résultats de quotients <span>exacts</span> et <span>finis</span>. J'ai donc mis en place une <span>bibliothèque</span> de valeurs dont leur résultats sont exact. Afin de conserver <span>l'algorithme</span> de génération de l'ombre dynamique, j'ai attribué ces valeurs sur les côtés de la figure et de la l'ombre. Les résultats alors calculer par les élèves sont toujours exacts et finis.
						<br />Grâce à cette bibliothèque de valeurs, j'ai donc pu rendre les exercices <span>re-jouable</span>, car a chaque nouvel exercice est <span>généré</span> une nouvel instance avec des valeurs et figures <span>différentes</span>.
					</p>
					...
					<img width="1140" height="563" src="image/cqfd/mainmenu.jpg" alt="Image du jeu" />
					<p>Après le menu principal du jeu, il fallait bien s'occuper du menu In-Game :</p>
					<iframe width="1140" height="563" src="https://www.youtube.com/embed/tkFeP2Tp0Us?loop=1&playlist=tkFeP2Tp0Us&showinfo=0&autoplay=1&controls=0" frameborder="0"></iframe>
