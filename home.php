...
<html>
	<head>
		...
		<title>Maxime Callet | Unity Developer</title>
	</head>
				...
				<header class="headhome">
					...
					<article>
						<div class="bordureflex">
							<div class="bordureh1lqui"></div>
							<h1>C'est qui ?</h1>
							<div class="bordureh1rqui"></div>
						</div>
					...
					<article>
						<div class="bordureflex">
							...
							<h1>Il fait quoi ?</h1>
							<div class="bordureh1rquoi"></div>
						</div>
						<p>Grâce à mes études et mon expérience professionnelle, je suis capable de clarifier et organiser des mécaniques de jeu à partir de simples idées de gameplay, de les prototyper sur Unity, et d’ajuster les réglages en fonction des besoins.</p>
					</article>
				</header>
