			...
			<section class="home">
				...
				<section class="contenu">
					...
					<p>
						...
						<br />Enfin, j'ai <span>développé</span> une <span>base de données</span> simple en <span>PHP</span> afin de <span>poster</span> les <span>meilleurs scores</span> atteints, les <span>stocker</span> sur mon <span>hérbegement web</span> pour finalement obtenir un classement des meilleurs scores en jeu.
					</p>
					<h1>Pitch</h1>
					<p>
					...
					<p>
						Une fois l'un de ces <span>collectible récupéré</span>, une sorte de <span>mini-jeu bonus</span> se déclanchera afin de <span>gagner</span> plus de <span>points</span> et/ou de <span>vitesse</span>.
